...
class PackageStreamWrapper implements StreamWrapperInterface
{
    ...
    {
        $resourceUriOrStream = $this->evaluatePath($path);
    ...
    {
        $resourceUriOrStream = $this->evaluatePath($path, false);
        if (is_string($resourceUriOrStream)) {
    ...
    {
        return @stat($this->evaluatePath($path));
    }
     ...
     */
    protected function evaluatePath($requestedPath, $checkForExistence = true)
    {
