...
class PackageStreamWrapperTest extends UnitTestCase
{
     ...
     * @test
     */
    public function openThrowsExceptionForPathesThatGoUpwards()
    {
        $this->expectException(\InvalidArgumentException::class);
        $openedPathAndFilename = '';
        $this->packageStreamWrapper->open('package://Vendor.Site/../bar', 'r', 0, $openedPathAndFilename);
    }
    ...
    public function openThrowsExceptionForNonExistingPackages()
    {
        ...
        $openedPathAndFilename = '';
        $this->packageStreamWrapper->open('resource://' . $packageKey . '/Some/Path', 'r', 0, $openedPathAndFilename);
    }
